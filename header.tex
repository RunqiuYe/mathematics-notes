...
%%%%% Maths Symbols %%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%
\newcommand{\seqinfl}[1]{\{ #1 \}_{l=0}^\infty}
\newcommand{\cupinfj}{\bigcup_{j=0}^\infty}
\newcommand{\capinfj}{\bigcap_{j=0}^\infty}
\newcommand{\suminfj}{\sum_{j=0}^\infty}
\newcommand{\seqinfj}[1]{\{ #1 \}_{j=0}^\infty}
\newcommand{\cupinfi}{\bigcup_{i=0}^\infty}
\newcommand{\capinfi}{\bigcap_{i=0}^\infty}
\newcommand{\suminfi}{\sum_{i=0}^\infty}
\newcommand{\seqinfi}[1]{\{ #1 \}_{i=0}^\infty}
\newcommand{\cupinfn}{\bigcup_{n=0}^\infty}
\newcommand{\capinfn}{\bigcap_{n=0}^\infty}
\newcommand{\suminfn}{\sum_{n=0}^\infty}
\newcommand{\seqinfn}[1]{\{ #1 \}_{n=0}^\infty}
\newcommand{\cupinfk}{\bigcup_{k=0}^\infty}
\newcommand{\sqcupinfk}{\bigsqcup_{k=0}^\infty}
\newcommand{\capinfk}{\bigcap_{k=0}^\infty}
\newcommand{\suminfk}{\sum_{k=0}^\infty}
\newcommand{\seqinfk}[1]{\{ #1 \}_{k=0}^\infty}
\newcommand{\cupinfm}{\bigcup_{m=0}^\infty}
\newcommand{\capinfm}{\bigcap_{m=0}^\infty}
\newcommand{\suminfm}{\sum_{m=0}^\infty}
\newcommand{\seqinfm}[1]{\{ #1 \}_{m=0}^\infty}

\newcommand{\cupj}{\bigcup_{j=0}}
\newcommand{\capj}{\bigcap_{j=0}}
\newcommand{\sumj}{\sum_{j=0}}
\newcommand{\seqj}[1]{\{ #1 \}_{j=0}}
\newcommand{\cupi}{\bigcup_{i=0}}
\newcommand{\capi}{\bigcap_{i=0}}
\newcommand{\sumi}{\sum_{i=0}}
\newcommand{\seqi}[1]{\{ #1 \}_{i=0}}
\newcommand{\cupn}{\bigcup_{n=0}}
\newcommand{\capn}{\bigcap_{n=0}}
\newcommand{\sumn}{\sum_{n=0}}
\newcommand{\seqn}[1]{\{ #1 \}_{n=0}}
\newcommand{\cupk}{\bigcup_{k=0}}
\newcommand{\capk}{\bigcap_{k=0}}
\newcommand{\sumk}{\sum_{k=0}}
\newcommand{\seqk}[1]{\{ #1 \}_{k=0}}
\newcommand{\cupm}{\bigcup_{m=0}}
\newcommand{\capm}{\bigcap_{m=0}}
\newcommand{\summ}{\sum_{m=0}}
\newcommand{\seqm}[1]{\{ #1 \}_{m=0}}
