...
\begin{thm}
  ...
  \begin{enumerate}
    ...
    \begin{enumerate}
      ...
      \item there exists $F \in F_\sigma$ such that 
...
there exists $B_n \in \mf$ such taht $A_n \subset B_n$
...
\[
\om(E \setminus F) \leq \sumn \om (E_n \setminus F_n) = 0.
\]
...
\leq \sumn \om(E \setminus C_{n, M(n, k)}) \leq 2^{-k+1}.
\]
